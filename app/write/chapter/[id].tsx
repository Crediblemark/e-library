...
// Mock data for chapters with block-based content
const chaptersData = {
  "1-1": {
    id: "1-1",
    projectId: "1",
    ...
    blocks: [
      ...
      },
      {
        ...
        type: "paragraph",
        content:
          "I was moving a heavy bookcase when I noticed it – a slight discoloration in the wall behind, a rectangle about the size of a door. My curiosity piqued, I pushed the bookcase further aside, revealing what appeared to be a sealed entrance. The edges were nearly invisible, painted over countless times, but there was definitely something there.",
      },
      {
        id: "b6",
        type: "quote",
        content:
          "Some secrets hide in plain sight, waiting for the right moment to be discovered.",
      },
      {
        id: "b7",
        type: "paragraph",
        content:
          "With a mixture of excitement and trepidation, I fetched a crowbar from my grandmother's old tool collection. It took some effort, but eventually, I managed to pry open what was indeed a door – one that clearly hadn't been opened in decades.",
      },
      {
        id: "b8",
        type: "paragraph",
        content:
          "Behind it was a narrow passageway, descending into darkness. The air that escaped was cool and stale, carrying a scent I couldn't quite identify – something earthy and ancient. I should have been afraid, perhaps, but instead, I felt an overwhelming sense of wonder.",
      },
      {
        id: "b9",
        type: "paragraph",
        content:
          "I returned upstairs to grab a flashlight, my heart racing with anticipation. Little did I know that stepping through that hidden door would change my life forever, leading me to a world I never knew existed right beneath our feet.",
      },
    ],
    status: "Published",
    ...
    blocks: [
      {
        ...
        type: "paragraph",
        content:
          "The flashlight beam cut through the darkness, revealing stone steps descending steeply into the earth. They were worn in the middle, suggesting countless feet had traversed them over the years. But that was impossible – this passage had been sealed for as long as I could remember, and my grandmother had never mentioned it.",
      },
      {
        id: "b2",
        type: "paragraph",
        content:
          "I tested the first step with my foot, finding it solid despite its aged appearance. The walls of the passage were lined with a strange, smooth stone that didn't match any building material I recognized. It had an almost luminous quality, seeming to absorb and reflect my flashlight's beam in equal measure.",
      },
      {
        id: "b3",
        type: "heading-2",
      ...
      },
      {
        ...
        type: "paragraph",
        content:
          "As I descended, the temperature dropped noticeably. By the time I reached the bottom – some thirty steps down – I could see my breath forming small clouds in the beam of light. The passage leveled out into a small antechamber, empty except for a stone pedestal in the center.",
      },
      {
        id: "b5",
        type: "paragraph",
